...
(function () {
  ...
  function constructor (containerElOrString, config) {
    ...
    function dropDraggedPieceOnSquare (square) {
      ...
      function onAnimationComplete () {
        ...
        if (isFunction(config.onSnapEnd)) {
          config.onSnapEnd(containerElOrString,draggedPieceSource, square, draggedPiece)
        }
      }
    ...
    function beginDraggingPiece (source, piece, x, y) {
      // run their custom    function
      // their custom onDragStart function can cancel drag start
      if (isFunction(config.onDragStart) &&
          config.onDragStart(containerElOrString, piece, deepCopy(currentPosition), currentOrientation) === false) {
        return
      }
    ...
    function mouseenterSquare (evt) {
      ...
      config.onMouseoverSquare(square, piece,containerElOrString ,deepCopy(currentPosition), currentOrientation)
    }
    ...
    function mouseleaveSquare (evt) {
      ...
      // execute their function
      config.onMouseoutSquare(square, piece,containerElOrString , deepCopy(currentPosition), currentOrientation)
    }
